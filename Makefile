...
OUT_NAME=bin/splc
BUILDDIR=build
SRCS=syntax.tab compiler/Container compiler/main compiler/Node compiler/Specifier compiler/Scope compiler/Dec compiler/Def compiler/Exp compiler/CompoundType compiler/Stmt
